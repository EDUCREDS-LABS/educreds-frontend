...
export const certificateSchema = z.object({
  ...
  revocationReasonCode: z.number().optional(),
  revocationDetailsUri: z.string().optional(),
  revocationNotes: z.string().optional(),
  revokedAt: z.date().optional(),
  revokedBy: z.string().optional(),
  revocationTxHash: z.string().optional(),
  revocationRequestStatus: z.string().optional(),
  revocationRequestReason: z.string().optional(),
  revocationRequestReasonCode: z.number().optional(),
  revocationRequestDetailsUri: z.string().optional(),
  revocationRequestNotes: z.string().optional(),
  revocationRequestRecordType: z.string().optional(),
  revocationRequestedAt: z.date().optional(),
  revocationRequestedBy: z.string().optional(),
  revocationReviewedAt: z.date().optional(),
  revocationReviewedBy: z.string().optional(),
