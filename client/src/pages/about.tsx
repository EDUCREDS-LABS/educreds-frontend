...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950 font-sans selection:bg-primary/20 transition-colors duration-300">
      <ModernHeader onStudentPortalClick={() => setLocation("/student-portal")} />
      
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-50 via-white to-white dark:from-blue-950/30 dark:via-neutral-950 dark:to-neutral-950"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <Badge variant="outline" className="mb-6 bg-white/80 dark:bg-neutral-900/80 backdrop-blur text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-900 px-4 py-1.5 rounded-full text-sm font-medium shadow-sm">
              Verifiable Education Network
            </Badge>
            <h1 className="text-4xl md:text-6xl font-bold font-heading text-neutral-900 dark:text-neutral-100 mb-6 leading-tight tracking-tight">
      ...
      {/* Philosophy Section */}
      <section className="py-20 bg-white dark:bg-neutral-950 border-y border-transparent dark:border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold font-heading text-neutral-900 dark:text-neutral-100 mb-6">
                Why We Exist
              </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="bg-blue-50 dark:bg-blue-950/30 border-none shadow-none">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100 mb-2">Global Reach</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400">Cross-border qualification recognition systems.</p>
                </CardContent>
              </Card>
              <Card className="bg-indigo-50 dark:bg-indigo-950/30 border-none shadow-none">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100 mb-2">Interoperable</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400">Composable infrastructure for the trust layer.</p>
                </CardContent>
              </Card>
              <Card className="bg-purple-50 dark:bg-purple-950/30 border-none shadow-none">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100 mb-2">Secure</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400">Cryptographic certainty and transparency.</p>
                </CardContent>
              </Card>
              <Card className="bg-cyan-50 dark:bg-cyan-950/30 border-none shadow-none">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  <div className="w-12 h-12 bg-cyan-100 dark:bg-cyan-900/50 rounded-full flex items-center justify-center mb-4 text-cyan-600 dark:text-cyan-400">
                    <Cpu className="w-6 h-6" />
                  </div>
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100 mb-2">AI-Assisted</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400">Intelligent governance and dispute resolution.</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-neutral-900 text-white ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-heading mb-6 text-blue-500">Technical Overview</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-neutral-800 border-neutral-700">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3 text-blue-500">Onchain Immutability</h3>
            ...
            <Card className="bg-neutral-800 border-neutral-700">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3 text-blue-500">Offchain Intelligence</h3>
                <p className="text-neutral-400 leading-relaxed">
            ...
            <Card className="bg-neutral-800 border-neutral-700">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3 text-blue-500">Proof of Institutional Credibility</h3>
                <p className="text-neutral-400 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Our Mission</h3>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Our Vision</h3>
              </div>
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Objective</h3>
              </div>
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
      ...
      {/* Team Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-neutral-900 dark:to-neutral-950">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
            ...
            <div className="text-center group">
              <div className="relative mb-6">
                <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-white shadow-lg group-hover:scale-105 transition-transform duration-300">
                  <img
                    src="https://res.cloudinary.com/dycszahnr/image/upload/q_auto/f_auto/v1775824628/CEO_zmg69p.jpg"
                    alt="Team Member 1"
              ...
              <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">KYOTOYINZE ABDULMAJID</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">MUDEBO SAMUSI</h3>
              <p className="text-neutral-600 dark:text-neutral-400 mb-4 text-sm">
                Full-stack developer and blockchain specialist
              </p>
              <div className="flex justify-center space-x-3">
                <a href="https://linkedin.com/in/mudebo-samusi" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.047-1.852-3.047-1.853 0-2.136 1.445-2.136 2.939v5.677H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                ...
                <a href="https://github.com/mudebo samusi" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 4.624-5.479 4.92.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                </a>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative mb-6">
                <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-white shadow-lg group-hover:scale-105 transition-transform duration-300">
                  <img
                    src="https://res.cloudinary.com/dycszahnr/image/upload/q_auto/f_auto/v1775824625/t1_jrcdxf.jpg"
                    alt="Team Member 3"
                    className="w-full h-full object-cover"
                    onError={(e) => {
                      const target = e.target as HTMLImageElement;
              ...
              <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">SSEKIZIYIVU PAUL</h3>
              <p className="text-neutral-600 dark:text-neutral-400 mb-4 text-sm">
                Network communications and UI/UX specialist
              </p>
              <div className="flex justify-center space-x-3">
                <a href="https://www.linkedin.com/in/paul-ssekiyivu-593649224?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.047-1.852-3.047-1.853 0-2.136 1.445-2.136 2.939v5.677H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
            ...
            <div className="text-center group">
              <div className="relative mb-6">
                <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-white shadow-lg group-hover:scale-105 transition-transform duration-300">
                  <img
                    src="https://res.cloudinary.com/dycszahnr/image/upload/q_auto/f_auto/v1775824625/t2_wz7ydu.jpg"
                    alt="Team Member 4"
                    className="w-full h-full object-cover"
                    onError={(e) => {
                      const target = e.target as HTMLImageElement;
              ...
              <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">NABASIRYE SEANICE</h3>
              <p className="text-neutral-600 dark:text-neutral-400 mb-4 text-sm">
              ...
              <div className="flex justify-center space-x-3">
                ...
                <a href="https://twitter.com/Seanice_N
" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-600 transition-colors">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">BALAMAGA EXPERITO</h3>
              <p className="text-neutral-600 dark:text-neutral-400 mb-4 text-sm">
