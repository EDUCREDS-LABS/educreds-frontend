  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <Card className="border-none shadow-xl shadow-neutral-200/40 dark:shadow-black/20 bg-neutral-50/50 dark:bg-neutral-900 rounded-[32px] overflow-hidden">
          <CardContent className="p-10 space-y-6">
            <div className="size-14 rounded-2xl bg-blue-100 dark:bg-blue-950 flex items-center justify-center text-blue-600 dark:text-blue-400">
              <ImageIcon className="size-6" />
            </div>
            <h3 className="text-2xl font-black text-neutral-900 dark:text-neutral-100 uppercase tracking-tight">Brand Assets</h3>
        ...
        <Card className="border-none shadow-xl shadow-neutral-200/40 dark:shadow-black/20 bg-neutral-50/50 dark:bg-neutral-900 rounded-[32px] overflow-hidden">
          <CardContent className="p-10 space-y-6">
            <div className="size-14 rounded-2xl bg-indigo-100 dark:bg-indigo-950 flex items-center justify-center text-indigo-600 dark:text-indigo-400">
              <FileText className="size-6" />
            </div>
            <h3 className="text-2xl font-black text-neutral-900 dark:text-neutral-100 uppercase tracking-tight">Executive Summary</h3>
            <p className="text-neutral-500 dark:text-neutral-400 font-medium leading-relaxed">
              Technical whitepapers, protocol architecture summaries, and the official mission statement.
            </p>
            <Button variant="outline" className="w-full h-12 rounded-xl border-neutral-200 dark:border-neutral-700 font-black text-xs uppercase tracking-widest hover:bg-white dark:hover:bg-neutral-800 dark:text-neutral-200">
