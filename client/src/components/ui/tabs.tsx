...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-start rounded-xl bg-background border border-border/60 p-1 text-muted-foreground shadow-md overflow-x-auto overflow-y-hidden no-scrollbar",
      className
    )}
    {...props}
  />
