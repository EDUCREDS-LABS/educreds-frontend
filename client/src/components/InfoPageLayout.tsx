    ...
    <div className="min-h-screen bg-white font-sans selection:bg-blue-500/20">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden border-b border-neutral-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            {badge && (
              <Badge variant="outline" className="mb-6 bg-white text-blue-600 border-blue-100 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm">
                {badge}
              </Badge>
            )}
            <h1 className="text-4xl md:text-6xl font-black text-neutral-900 mb-6 tracking-tight leading-[0.9] uppercase">
              {title}
            </h1>
